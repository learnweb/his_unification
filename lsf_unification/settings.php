...
*/
    ...
    $settings->add(new admin_setting_configtext('local_lsf_unification/max_import_age',
		...
		365, PARAM_INT));
    $settings->add(new admin_setting_configtext('local_lsf_unification/roleid_creator',
        get_string('roleid_creator', 'local_lsf_unification'), get_string('roleid_creator_description', 'local_lsf_unification'),
