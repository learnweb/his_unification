...
###Sicht Belegung der Studierenden zu einer Veranstaltung, //Wir bekommen über unser SSO die Matrikelnr der Studierenden, möglicherwese bekommen wir bald auch eine Kennung mitgeliefert.
SELECT r_beleg.veranstid, r_beleg.status, r_beleg.tabpk AS mtknr, r_beleg.zeitstempel
   FROM r_beleg;

### Abkürungen von Status in Eingeschrieben
STATUS, BEDEUTUNG
AN Angemeldet
ZU Zugelassen
AB Abgemeldet
