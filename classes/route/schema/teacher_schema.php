...
/**
 * Schema of a single teacher.
 *
 * Shared by the responses that return teachers and by the request bodies that accept one,
 * so that a change only has to be made here.
 *
 * @package   local_lsf_unification
 * @copyright 2026 Tamaro Walter
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class teacher_schema extends schema_object {
    /**
     * Constructor.
     *
    ...
    public function __construct(bool $required = false) {
        parent::__construct(
            content: [
                'username' => new scalar_type(param::USERNAME, required: $required),
                'firstname' => new scalar_type(param::RAW, required: $required),
                'lastname' => new scalar_type(param::RAW, required: $required),
            ],
        );
    }
