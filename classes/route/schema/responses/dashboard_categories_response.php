...
/**
 * Response specification of the array of Moodle categories the teacher can pick from in the wizard.
 *
 * @package   local_lsf_unification
 * @copyright 2026 Tamaro Walter
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dashboard_categories_response extends response {
    /**
     * Constructor.
