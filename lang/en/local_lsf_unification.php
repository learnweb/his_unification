...
$string['category_choose'] = 'Choose a category ...';
$string['category_validate'] = 'Please choose a category.';
$string['categoryinvalid'] = 'please choose a category from this selection';
$string['choose_action'] = 'What do you want to do?';
$string['choose_action_import'] = 'Import an existing course from the HIS-LSF or SAP platform to moodle.';
$string['choose_action_request'] = 'Request a course on behalf of a teacher.';
...
$string['course_import'] = 'Course import';
$string['course_request'] = 'Course request';
$string['coursedetails_text'] = 'Edit the course details and choose a category the course will be assigned to.';
$string['coursedetails_title'] = 'Course details';
$string['courseselect'] = 'Select course';
$string['courseselect_import'] = 'Choose the course you want to import to Moodle';
$string['courseselect_request'] = 'Choose the course you want to request.';
$string['courseselect_validate'] = 'Please choose a course to continue.';
...
$string['dashboard_request_state_pending'] = "pending";
$string['dashboard_request_teacher'] = "on behalf of ";
$string['dashboard_requested_courses'] = 'Requested courses';
$string['dashboard_title'] = 'CMS Dashboard';
$string['dashboard_title_text'] = 'Administrate your courses from external course management systems';
$string['dashboard_to_course'] = 'Go to course';
$string['dashboard_wizard_button'] = 'New course request';
...
$string['eventcourse_duplicated_desc'] = 'The user with id {$a->userid} duplicated contents from course with id {$a->other} into a course with id {$a->objectid}.';
$string['eventcourse_imported'] = 'Course imported';
$string['eventcourse_imported_desc'] = 'The user with id {$a->userid} imported the HISLSF-course with veranstid {$a->other} as a new moodle course with id {$a->objectid}.';
$string['eventmatchingtable_updated'] = 'Matchingtable updated';
$string['eventmatchingtable_updated_desc'] = 'The user with id {$a->userid} updated a his category matching with id {$a->objectid}. Original mapping: {$a->mappingold}. New mapping: {$a->mappingnew}.';
...
$string['semester_validate'] = 'Please enter a semester.';
...
$string['shorttitle_validate'] = 'Please enter a valid short title.';
...
$string['submit_import_error'] = 'The course could not be imported. Please try again.';
$string['submit_import_label'] = 'Import course';
$string['submit_import_success'] = 'The course was imported successfully.';
$string['submit_request_error'] = 'The course request could not be send. Please try again.';
$string['submit_request_label'] = 'Request course';
$string['submit_request_success'] = 'The course request was saved successfully and the teacher was notified. Please wait for an answer.';
$string['summary_import_text'] = 'Please check the details before submitting the course import.';
$string['summary_import_title'] = 'Summary of the course import';
$string['summary_request_text'] = 'Please check the details before submitting the course request.';
$string['summary_request_title'] = 'Summary of the course request';
...
$string['title'] = "Title";
$string['title_validate'] = "Please enter a valid title.";
...
$string['wizard_shell_back'] = 'Back';
$string['wizard_shell_next'] = 'Next';
$string['wizard_shell_title'] = 'Course integration';
