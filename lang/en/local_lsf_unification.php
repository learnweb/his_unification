...
$string['dbsslcert'] = 'TLS/SSL certificate';
$string['dbsslcert_description'] = 'The file name of the client TLS/SSL certificate.';
$string['dbsslkey'] = 'TLS/SSL secret key';
$string['dbsslkey_description'] = 'The file name of the secret key of the client TLS/SSL certificate.';
$string['dbsslrootcert'] = 'TLS/SSL root certificate';
$string['dbsslrootcert_description'] = 'The file name of a file containing TLS/SSL certificate authority (CA) certificate(s). These will be used when verifying the database server’s certificate';
$string['dbuser'] = 'User';
$string['dbuser_description'] = 'PostgreDB-User';
$string['dbusessl'] = 'Use TLS/SSL for authentication';
$string['dbusessl_description'] = 'Use a TLS/SSL client certificate for authentication. When checked, the password will be ignored and the certificate settings will be used for authentication.';
